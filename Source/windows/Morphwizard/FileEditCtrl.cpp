...
//
//  Note :
//    Thanks to Michael Dunn for his article "Introduction to windows - What It Is and How to Use It."
...
BOOL CFileEditCtrl::DereferenceLink(CString &FileName)
{
    ...
    // initialize the windows libraries
    CoInitialize (NULL);
