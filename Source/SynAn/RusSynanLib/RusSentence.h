...
/*
 стр-ра нужна для выбора второй компоненты ан.ф. глагола с вспом.гл. "быть" или "стать" 
*/
struct SAnalyticalFormVariant
{
	...
	//задается порядок : лучший потенциальный предикат тот, который имеет
	//меньше всего омонимов, последний в векторе тот, который является сравн. степ. прил.
