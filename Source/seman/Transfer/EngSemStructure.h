...
public:
	...
	*/
	...
	bool HasStringInCortege(DictTypeEnum type, TCortege cortege, const std::string& str) const;
	...
	const TCortege*  NumPrepPhr(const std::vector<TCortege>& GramCorteges, DictTypeEnum type) const;
