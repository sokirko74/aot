...
public:
	...
	const std::vector<TCortege>& GetGramCorteges() const;
	void AddGramCortege(const TCortege& c);
	void DeleteGramCortege(size_t index);
	void DeleteAllGramCortege();
	void CopyGramCorteges(const CSemPattern& from);
