...
std::vector<CFormGroup> GetParadigmByGroups(const std::vector<CFormAndGrammems> &Forms, const CMorphologyHolder *Holder, grammems_mask_t &CommonGrammems)
{
...
std::vector<CFormGroup> BuildInterfaceParadigmPart(const CMorphologyHolder *Holder, const std::vector<CFormAndGrammems> FormAndGrammems, int &FormNo, grammems_mask_t &commonGrammems)
{
...
std::string CMorphologyHolder::LemmatizeJson(std::string WordForm, bool withParadigm, bool prettyJson, bool sortForms) const
{
