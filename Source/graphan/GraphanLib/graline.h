...
// bits for CGraLine::m_AuxDescriptors
...
class CGraLine {
    ...
    void InitWordsAndNumbers(bool b_force_to_rus);
public:
    ...
    static std::string GetStringByDescriptors(uint64_t descriptors);
};
