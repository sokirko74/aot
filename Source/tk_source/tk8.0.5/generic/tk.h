 ...
 *
 * RCS: @(#) $Id: tk.h,v 1.1 2009-04-23 06:48:47 sokirko Exp $
 */
...
EXTERN Tk_PhotoHandle	Tk_FindPhoto _ANSI_ARGS_((Tcl_Interp *interp,
			    char *imageName));
EXTERN _X_Font		Tk_FontId _ANSI_ARGS_((Tk_Font font));
