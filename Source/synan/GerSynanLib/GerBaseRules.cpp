...
// (2) "Es gebe eine Reihe von Kunden , die AOL nur wegen der fehlenden Mцglichkeit, Bankgeschдfte zu tдtigen , nicht abonniert hatten"
...
bool CGerSentence::RuleForEmptyClauses(int iClauseNum)
{
	...
	//  for example
	// Цsterreich habe dem deutschen Volk, zu dem es sich bekenne, Dienste geleistet.
	if (iPrev != -1)
	{
